...
const Subintro = ({ heading, description, buttonText, IsHead , subHeadName , IsButton , onClick }) => {
  return (
    <div className="subintro-container">
      ...
      {
      IsButton == true &&
        <div className="row subintro-btn-row">
        <div className="col subintro-btn-col">
          <button className="subintro-btn" onClick={onClick}>
            {buttonText}
